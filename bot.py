...
ОПИСАНИЯ = {
    ...
    # показатели
    "⚡ сейчас": "итоги текущего дня: выручка, план, заказы, скорость",
    ...
    "⏱ время работы": "скорость доставки: кухня, ожидание, курьер против цели",
    ...
    "🛑 стоп-лист": "чего сейчас нет в продаже и на какую сумму",
    ...
    # цены
    "🔍 найти позицию": "найти блюдо и узнать его ЦЕНУ ДЛЯ ГОСТЯ и артикул",
    ...
    "👤 kpi админов": "премия администраторов за выполнение недельного плана",
...
def _каталог_экранов():
    """Экраны с описаниями — для языковой модели. Только то, что открыто
    этому боту; кнопки без описания пропускаем, а не показываем голыми."""
